...
/**
 * Handles the 'resolveImperialChina' action.
...
exports.execute = async (lobbyId, playerId, payload, afterData) => {
  ...
  // Discard card and gain money
  discardCard(player, hand, cardIndex, lobbyData, {name: "Imperial China",
    type: "white"});
  player.handCount = hand.length;
  gainMoney(player, 4, lobbyData, {name: "Imperial China", type: "white"});
